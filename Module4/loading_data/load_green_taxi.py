...
# 2. Updated BASE_URL for Green Taxi
...
def download_file(year_month):
    ...
    # 3. Updated filename logic to use "green" instead of "yellow"
...
def create_bucket(bucket_name):
    try:
        ...
        print(f"Bucket '{bucket_name}' exists but is inaccessible.")
        sys.exit(1)
...
if __name__ == "__main__":
    ...
    # 24 tasks total (12 months x 2 years)
    download_tasks = [(year, month) for year in YEARS for month in MONTHS]

    # Upping workers to 8 for efficiency, as discussed!
    ...
    print("\nAll Green Taxi files processed and verified.")